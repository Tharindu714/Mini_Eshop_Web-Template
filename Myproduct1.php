              ...
              <div class="offset-1 col-10 text-center">
                <div class="row justify-content-center">
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\mobileprod\Galaxy S 20 FE.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">Samsung Galaxy S20 (Devil Blue) </h5>
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\mobileprod\Galaxy Xcover 6Pro -2.jpeg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">Samsung Galaxy Xcover 6 PRO (Bare Black) </h5>
                          <span class="card-text fw-bold text-primary">Rs.110000.00</span> <br />
                          <span class="card-text fw-bold text-success">18 items left </span><br />
                          <div class="form-check form-switch">
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\mobileprod\Samsung_Galaxy_A13 -1.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">Samsung Galaxy A13 (Sky Blue) </h5>
                          <span class="card-text fw-bold text-primary">Rs.75000.00</span> <br />
                          <span class="card-text fw-bold text-success">18 items left </span><br />
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="fd" checked />
                            <label class="form-check-label fw-bold text-primary" for="fd"><b>Make Your Product Active</b></label>
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\mobileprod\Samsung_Galaxy_A13.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">Samsung Galaxy A13 (Bare Black) </h5>
                          <span class="card-text fw-bold text-primary">Rs.80000.00</span> <br />
                          <span class="card-text fw-bold text-success">38 items left </span><br />
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="fd" checked />
                            <label class="form-check-label fw-bold text-primary" for="fd"><b>Make Your Product Active</b></label>
                          </div>
              ...
              <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mb-3">
                <nav aria-label="Page navigation example">
                  <ul class="pagination pagination-lg justify-content-center ">
                    <li class="page-item">
                      <a class="page-link bg-transparent" href="Myproduct2.php" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                      </a>
                    </li>

                        <li class="page-item">
                          <a class="page-link bg-transparent" href="Myproduct4.php"> 1 </a>
                        </li>
                        <li class="page-item ">
                          <a class="page-link bg-transparent" href="Myproduct3.php"> 2 </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link bg-transparent" href="Myproduct5.php"> 3 </a>
                        </li>
                        <li class="page-item">
                    ...
                    <li class="page-item">
                      <a class="page-link bg-transparent" href="Myproduct4.php" aria-label="Next">
