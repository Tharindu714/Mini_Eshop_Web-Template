              ...
              <div class="offset-1 col-10 text-center">
                <div class="row justify-content-center">
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\products\ps2 red.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">OLD modified Play Station 2 Console (RED) </h5>
                          <span class="card-text fw-bold text-primary">Rs.65000.00</span> <br />
                          <span class="card-text fw-bold text-danger">0 items left </span><br />
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="fd"/>
                            <label class="form-check-label fw-bold text-primary" for="fd"><b>Make Your Product Deactive</b></label>
                          </div>
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\products\xbox1 1.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">XBOX 1 White console brand </h5>
                          <span class="card-text fw-bold text-primary">Rs.150000.00</span> <br />
                          <span class="card-text fw-bold text-success">100 items left </span><br />
                          <div class="form-check form-switch">
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\products\xbox360 2.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">XBOX 360 Jet Black branded console + GTA 5 Original Edition</h5>
                          <span class="card-text fw-bold text-primary">Rs.220000.00</span> <br />
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\products\psp.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">Playstation Branded Edition Portable console </h5>
                          <span class="card-text fw-bold text-primary">Rs.78000.00</span> <br />
                          <span class="card-text fw-bold text-success">80 items left </span><br />
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="fd" checked />
                            <label class="form-check-label fw-bold text-primary" for="fd"><b>Make Your Product Active</b></label>
                          </div>
              ...
              <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mb-3">
                <nav aria-label="Page navigation example">
                  <ul class="pagination pagination-lg justify-content-center ">
                    <li class="page-item">
                      <a class="page-link bg-transparent" href="Myproduct3.php" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                      </a>
                    </li>

                        <li class="page-item">
                          <a class="page-link bg-transparent" href="Myproduct.php"> 1 </a>
                        </li>
                        <li class="page-item ">
                          <a class="page-link bg-transparent" href="Myproduct1.php"> 2 </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link bg-transparent" href="Myproduct2.php"> 3 </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link bg-transparent" href="Myproduct3.php"> 4 </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link bg-transparent" href="Myproduct4.php"> 5 </a>
                        </li>
                        <li class="page-item">
                          <a class="page-link bg-transparent" href="Myproduct5.php"> 6 </a>
                        </li>

                    <li class="page-item">
                      <a class="page-link bg-transparent" href="Myproduct3.php" aria-label="Next">
