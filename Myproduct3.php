              ...
              <div class="offset-1 col-10 text-center">
                <div class="row justify-content-center">
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\products\maxresdefault.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">Nintendo Switch Pro Indigo set </h5>
                          <span class="card-text fw-bold text-primary">Rs.100000.00</span> <br />
                          <span class="card-text fw-bold text-success">69 items left </span><br />
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\products\nintendo-switch-oled.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">Nintendo Milk White console OLED model </h5>
                          <span class="card-text fw-bold text-primary">Rs.100000.00</span> <br />
                          <span class="card-text fw-bold text-success">50 items left </span><br />
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="fd" checked />
                            <label class="form-check-label fw-bold text-primary" for="fd"><b>Make Your Product Active</b></label>
                          </div>
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\products\nintendoswitch.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">Red & Blue Nintendo consold Wild card Set </h5>
                          <span class="card-text fw-bold text-primary">Rs.85000.00</span> <br />
                  ...
                  <div class="card mb-3 mt-3 col-12 col-lg-6 bg-transparent">
                    <div class="row">
                      <div class="col-md-4 mt-4">
                        <img src="resources\products\ps2 blue.jpg" class="img-fluid rounded-start" />
                      </div>
                      <div class="col-md-8">
                        <div class="card-body">
                          <h5 class="card-title fw-bold text-light">OLD modified Play Station 2 Console (BLUE) </h5>
                          <span class="card-text fw-bold text-primary">Rs.65000.00</span> <br />
                          <span class="card-text fw-bold text-success">2 items left </span><br />
                          <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="fd" checked />
                            <label class="form-check-label fw-bold text-primary" for="fd"><b>Make Your Product Active</b></label>
                          </div>
              ...
              <div class="offset-2 offset-lg-3 col-8 col-lg-6 text-center mb-3">
                <nav aria-label="Page navigation example">
                  <ul class="pagination pagination-lg justify-content-center ">
                    ...
                    <li class="page-item">
                      <a class="page-link bg-transparent" href="Myproduct1.php" aria-label="Next">
